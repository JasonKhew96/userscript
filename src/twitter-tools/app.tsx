...
const processSpan = (span: HTMLSpanElement) => {
  ...
  const regex =
    /(総?作画?監督?|第?(2|２|二)原画?|原画|コンテ|演出|脚本|担当|美術|背景|制作|仕上|動画?検査?|手伝い|参加|カット|レイアウト|key animat(or|ion)|\bcuts?\b|\bgenga\b|\bnigen\b|\blo\b|sakkan|layouts?|storyboards?|animation direction|\bpart\b|episode director)/gi
